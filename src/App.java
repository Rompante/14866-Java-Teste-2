...
// GUARDAR NOVO CLIENTE
        server.createContext("/guardar", exchange -> {
            ...
            try {
                ...
                String sql = "INSERT INTO clientes(nif,nome,email,telefone,pais) VALUES (?,?,?,?,?)";
        ...
        server.createContext("/editar", exchange -> {
            ...
            try {
                ...
                html.append("Telefone:<input name='telefone' value='").append(telefone).append("' required>");
        ...
        server.createContext("/atualizar", exchange -> {
            ...
            try {
                ...
                String sql = "UPDATE clientes SET nif=?, nome=?, email=?, telefone=?,pais=? WHERE id=?";
                PreparedStatement ps = con.prepareStatement(sql);
      ...
      server.createContext("/animaislista", exchange -> {
            ...
            StringBuilder html = new StringBuilder();
                ...
                html.append("""
                    ...
                    <a href='/animaisnovo'>+ Novo Animais</a><br><br>
    ...
    // FORM EDITAR
        server.createContext("/animaiseditar", exchange -> {
            ...
            try {
                ...
                html.append("<input type='hidden' name='id' value='").append(id).append("'>");
                html.append("Nif:<input name='nif' value='").append(numeroCA).append("' required>");
                html.append("Nome:<input name='nome' value='").append(nomeAnimal).append("' required>");
                html.append("Email:<input name='email' value='").append(dataNascimento ).append("' required>");
